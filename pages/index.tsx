...
const Home: NextPage<HomePageProps> = ({ step }) => {
  ...
  return (
    <Layout withHeader>
      <div className="md:max-w-[1200px] w-full p-12 flex md:flex-row flex-col sm:justify-start justify-center text-gray-600">
        <div className="h-full w-full bg-gray-400 rounded-lg mr-12">
          <Link href="/slides">
            <div>
              {images.map(
                (src, i) =>
        ...
        <div className="h-full sm:w-[500px] w-full py-4">
          ...
          <Link href="/slides">
            <button className="px-5 py-2.5 relative rounded group font-medium text-gray-200 hover:text-white font-medium inline-block">
